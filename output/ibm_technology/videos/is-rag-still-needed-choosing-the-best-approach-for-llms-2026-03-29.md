...
| **URL** | [Watch on YouTube](https://www.youtube.com/watch?v=UabBYexBD4k&pp=0gcJCdQKAYcqIYzv) |
| **Category** | - |
| **Language** | - |
---
...
|-----------|-----|------------|
| Views | 691,634 | `0.6030` |
| Likes | 0 | `0.0000` |
| Comments | 0 | `0.0000` |
| Engagement rate | `0.000000` | `0.0000` |
| **Final score** | | **`0.277712`** |
...
| **Language** | `en` |
| **Characters** | `0` |
| **Error** | `youtube_transcript_api: Could not retrieve a transcript for the video https://www.youtube.com/watch?v=UabBYexBD4k! This is most likely caused by:
