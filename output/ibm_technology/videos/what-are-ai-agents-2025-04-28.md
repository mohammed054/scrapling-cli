![Thumbnail](https://i.ytimg.com/vi/F8NKVhkZZWI/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLDXK6EPkpdKZq7C81K4xekZm1ByRg)
...
| **URL** | [Watch on YouTube](https://www.youtube.com/watch?v=F8NKVhkZZWI) |
| **Category** | - |
| **Language** | - |
---
...
`IBM` `IBM Cloud` `Artificial Intelligence` `AI` `Generative AI` `Gen AI` `AI agents` `compound AI systems` `generative AI shifts` `large language models` `LLM` `system design` `AI integration` `retrieval augmented generation` `RAG` `RAG systems` `AI autonomy` `reasoning models` `external tools in AI`
---
...
| **Language** | `en` |
| **Characters** | `0` |
| **Error** | `youtube_transcript_api: Could not retrieve a transcript for the video https://www.youtube.com/watch?v=F8NKVhkZZWI! This is most likely caused by:
