![Thumbnail](https://i.ytimg.com/vi/Hwnct9rqaCY/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLC9RWPMqfwk7GI5ns7RYbeLXEsdMA)
...
| **Subscribers** | 645,000 |
| **URL** | [Watch on YouTube](https://www.youtube.com/watch?v=Hwnct9rqaCY) |
| **Category** | - |
| **Language** | - |
---
...
|-----------|-----|------------|
| Views | 107,925 | `0.8776` |
| Likes | 0 | `0.0000` |
| Comments | 0 | `0.0000` |
| Engagement rate | `0.000000` | `0.0000` |
| **Final score** | | **`0.161434`** |
...
`Digital Transformation` `ERP Implementation` `Software Vendor` `System Integrator` `SAP Implementation Failure` `Resistance to Change` `Business Processes` `OCM` `Software Customization` `S/4HANA` `Technology Misalignment` `Project Governance` `Internal Alignment` `Resource Management`
---

## Description

A few years ago the German grocery retailer, Lidl, had a $600M SAP disaster. How is this even possible and what are the lessons we can learn from this?

That’s what I will be discussing today.

#sapimplementation #s4hana #digitaltransformation #changemanagement 
...
| **Language** | `en` |
| **Characters** | `0` |
| **Error** | `youtube_transcript_api: Could not retrieve a transcript for the video https://www.youtube.com/watch?v=Hwnct9rqaCY! This is most likely caused by:
