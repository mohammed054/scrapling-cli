![Thumbnail](https://i.ytimg.com/vi/GAJ0euuMgOk/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLD-xAW-6PNJP-a-V9q4wVQzr-8E8A)
...
| **Subscribers** | 645,000 |
| **URL** | [Watch on YouTube](https://www.youtube.com/watch?v=GAJ0euuMgOk) |
| **Category** | - |
| **Language** | - |
---
...
`Digital Transformation` `ERP Implementation` `Software Vendor` `System Integrator` `Consulting` `Big 4 Consulting` `Independent Consulting Firms` `ERP Software` `Independent Advisory` `Client-Centric Approach`
---

## Description

The big, global consulting firms have long dominated the ERP and digital transformation space, but their time has come to an end.

That’s what I will be discussing today.

#consulting #consultant #erpsoftware #digitaltransformation 
...
| **Language** | `en` |
| **Characters** | `0` |
| **Error** | `youtube_transcript_api: Could not retrieve a transcript for the video https://www.youtube.com/watch?v=GAJ0euuMgOk! This is most likely caused by:
