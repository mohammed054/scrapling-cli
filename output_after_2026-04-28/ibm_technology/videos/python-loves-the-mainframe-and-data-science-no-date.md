![Thumbnail](https://i.ytimg.com/vi/s75Ysq38TZE/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLANqohOP7-S0-lx9CKTY_vsCCWZdA)

# Python Loves the Mainframe and Data Science
---
...
| **URL** | [Watch on YouTube](https://www.youtube.com/watch?v=s75Ysq38TZE) |
| **Category** | - |
| **Language** | - |
---
...
Learn industry-critical computing skills → https://ibm.biz/check-out-Z-Xplore
IBM Mainframes: Meet the New IBM Z → https://ibm.biz/IBM_zSystems

Love programming in Python? 
Then check out this video in which Rosalind Radcliffe explains why your love of the Python just might translate into a new love of the mainframe.

Get started for free on IBM Cloud → https://ibm.biz/sign-up-today
Subscribe to see more videos like this in the future → http://ibm.biz/subscribe-now

#mainframe #python #zos
---
