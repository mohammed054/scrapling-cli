![Thumbnail](https://i.ytimg.com/vi/JCrvxWZEtSY/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAe5vvFBrKNdh-omG8MbT4N34FPJg)
...
| **URL** | [Watch on YouTube](https://www.youtube.com/watch?v=JCrvxWZEtSY) |
| **Category** | - |
| **Language** | - |
---
...
`IBM Cloud` `Quantum Computer` `Quantum Computing` `Error mitigation` `quantum error mitigation` `QuantumSimulation`
---

## Description

IBM Quantum Computing Roadmap → https://ibm.biz/BdysQS
Read the paper → https://ibm.biz/BdM5wi

A research paper from IBM Quantum and UC Berkeley has delivered compelling evidence suggesting that today’s noisy, error-prone quantum computers will soon be able to solve truly useful problems that are beyond the reach of classical computation. In this video, co-authors and IBM Quantum researchers Andrew Eddins and Youngseok Kim explain the experiment they used to draw these conclusions, and the crucial role that error mitigation will play in achieving useful quantum computing in the near term. The error mitigation technique they describe is now available via IBM’s quantum computing service, Qiskit Runtime, now available through IBM Cloud.

Get started for free on IBM Cloud → https://ibm.biz/sign-up-today

Subscribe to see more videos like this in the future → http://ibm.biz/subscribe-now

#software #ITModernization #QuantumComputing #UsefulQuantumComputing #QuantumErrorMitigation #ErrorMitigation #QuantumSimulation
---
